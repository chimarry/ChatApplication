...
namespace ChatApplication.WebAPI.ErrorHandling
{
    /// <summary>
    ...
    public class ErrorHandlingMiddleware
    {
        ...
        private static Task HandleException(HttpContext context, Exception ex)
        {
            ...
            else if (ex is MaliciousAttackException) (code, result) = (HttpStatusCode.BadRequest, JsonConvert.SerializeObject(new { error = ex.Message }));
            else if (ex is RefreshTokenException) (code, result) = (HttpStatusCode.BadRequest, JsonConvert.SerializeObject(new { error = ex.Message }));
