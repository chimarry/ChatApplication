...
{
    /// <summary>
    /// Data class that enables sharing result, status and detailed message as outcome of execution of some method 
    /// </summary>
    ...
    public class ResultMessage<T>
    {
        ...
        public ResultMessage((OperationStatus status, string detailedMessage) errorInformation)
            : this(errorInformation.status, errorInformation.detailedMessage)
        {
        }
